...
public class FunctionalInterface {
	public static void main(String[] args) {
		...
		String[] str = {"Roopa", "Rohini","Preethi"};
		...
		Predicate<String[]> predicate = (string) -> Arrays.toString(string).contains("Roopa");     //The Predicate interface has only one single method test().
